...
public class StudentEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("학생1 - 중간 고사 점수 : " + student.getAverage(100, 90));
		System.out.println("학생1 - 기말 고사 점수 : " + student.getAverage(100, 85, 70));
		System.out.println("학생1 - 최종 점수 : " + student.getAverage(scores));		
		
		// 학생2(Student2) 객체를 생성하면서, 아래와 같이 객체를 초기화 하세요.
		// - 이름 : 내 이름
		// - 나이 : 20
		// - 학번 : T100200
		// - 전공 : 내 전공
		Student student2 = new Student("김메가", 20, "T100200", "컴퓨터공학과");
		...
		student.study("자바 프로그래밍");
		System.out.println("학생2 - 중간 고사 점수 : " + student2.getAverage(100, 90));
		System.out.println("학생2 - 기말 고사 점수 : " + student2.getAverage(100, 85, 70));
