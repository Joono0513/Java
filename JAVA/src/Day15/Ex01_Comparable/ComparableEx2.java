...
public class ComparableEx2 {
	...
	public static void main(String[] args) {
		...
		movieList.add(new Movie("이웃집 토토로", "토토로", 20000));
		movieList.add(new Movie("스즈메의 문단속", "스즈메", 12000));
		movieList.add(new Movie("라이언 일병 구하기", "스티븐 스필버그", 14000));
		...
		// 정렬
		// * Book 객체에 구현된 compareTo() 메소드의 비교 기준으로 정렬
