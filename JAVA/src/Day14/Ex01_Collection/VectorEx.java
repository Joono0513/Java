...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		// Vector 객체 생성
		Vector<Integer> list = new Vector<Integer>();	// 기본 생성 : 기본 용량 10, 2배씩 증분
		// 요소 추가
		list.add(1);
		list.add(2);
		list.add(3);
		...
		// 반복 방법2
		// * foreach 문
		System.out.println(">> 반복2 - foreach 문");
		...
		System.out.println(vector);
		// - 삭제할 때, 삭제한 위치 뒤 index가 앞으로 한칸씩 당겨진다.
									// 0		1		2		3		4
